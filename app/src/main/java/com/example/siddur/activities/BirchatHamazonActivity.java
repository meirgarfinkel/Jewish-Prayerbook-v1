...
public class BirchatHamazonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_birchat_hamazon);
    ...
    private void addViews() {
        textViews.add(findViewById(R.id.birchat1));
        textViews.add(findViewById(R.id.birchat2));
        textViews.add(findViewById(R.id.birchat3));
        textViews.add(findViewById(R.id.birchat4));
    }

    private void setupVariables() {
        sharedPref = getSharedPreferences("my_shared_pref", MODE_PRIVATE);
        txtvw = findViewById(R.id.birchat1);
        scrlvw = findViewById(R.id.birchatScrollView);
