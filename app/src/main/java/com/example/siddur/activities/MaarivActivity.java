...
public class MaarivActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maariv);
    ...
    private void addViews() {
        textViews.add(findViewById(R.id.maariv1));
    }

    private void setupVariables() {
        sharedPref = getSharedPreferences("my_shared_pref", MODE_PRIVATE);
        txtvw = findViewById(R.id.maariv1);
        scrlvw = findViewById(R.id.maarivScrollView);
