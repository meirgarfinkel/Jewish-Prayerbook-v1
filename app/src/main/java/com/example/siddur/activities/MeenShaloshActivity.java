...
public class MeenShaloshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meen_shalosh);
    ...
    private void addViews() {
        textViews.add(findViewById(R.id.meen1));
    }

    private void setupVariables() {
        sharedPref = getSharedPreferences("my_shared_pref", MODE_PRIVATE);
        txtvw = findViewById(R.id.meen1);
        scrlvw = findViewById(R.id.meenScrollView);
