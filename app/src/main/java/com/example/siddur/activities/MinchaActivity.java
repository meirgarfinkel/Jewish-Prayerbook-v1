...
public class MinchaActivity extends AppCompatActivity {
    ...
    private void addViews() {
        textViews.add(findViewById(R.id.mincha1));
        textViews.add(findViewById(R.id.mincha2));
        textViews.add(findViewById(R.id.mincha3));
        textViews.add(findViewById(R.id.mincha4));
        textViews.add(findViewById(R.id.mincha5));
        textViews.add(findViewById(R.id.mincha6));
        textViews.add(findViewById(R.id.mincha7));
        textViews.add(findViewById(R.id.mincha8));
    }

    private void setupVariables() {
        sharedPref = getSharedPreferences("my_shared_pref", MODE_PRIVATE);
        txtvw = findViewById(R.id.mincha1);
        scrlvw = findViewById(R.id.minchaScrollView);
